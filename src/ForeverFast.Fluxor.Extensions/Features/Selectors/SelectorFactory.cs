namespace Fluxor.Extensions
{
    ...
    {
        public static MemoizedSelector<TIn1, TResult> CreateSelector<TIn1, TResult>(
            ISelector<TIn1> inS1,
            Func<TIn1, TResult> projector)
            => new MemoizedSelector<TIn1, TResult>(inS1, projector);

        public static MemoizedSelector<TIn1, TIn2, TResult> CreateSelector<TIn1, TIn2, TResult>(
            ISelector<TIn1> inS1,
            ISelector<TIn2> inS2,
            Func<TIn1, TIn2, TResult> projector)
            => new MemoizedSelector<TIn1, TIn2, TResult>(inS1, inS2, projector);
        ...
        public static MemoizedSelector<TIn1, TIn2, TIn3, TResult> CreateSelector<TIn1, TIn2, TIn3, TResult>(
            ...
            => new MemoizedSelector<TIn1, TIn2, TIn3, TResult>(inS1, inS2, inS3, projector);
        ...
        public static MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TResult> CreateSelector<TIn1, TIn2, TIn3, TIn4, TResult>(
            ...
            => new MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TResult>(inS1, inS2, inS3, inS4, projector);
        ...
        public static MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TResult> CreateSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TResult>(
            ...
            => new MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TResult>(inS1, inS2, inS3, inS4, inS5, projector);
        ...
        public static MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TResult> CreateSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TResult>(
            ...
            => new MemoizedSelector<TIn1, TIn2, TIn3, TIn4, TIn5, TIn6, TResult>(inS1, inS2, inS3, inS4, inS5, inS6, projector);

        public static Selector<TFeatureState> CreateFeatureSelector<TFeatureState>(string name)
            => new Selector<TFeatureState>(store =>
            {
